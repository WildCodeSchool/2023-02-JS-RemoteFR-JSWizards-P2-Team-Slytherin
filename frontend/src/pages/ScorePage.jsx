      ...
      <Layout>
        <div>
          ...
          <div className=" z-0 ml-auto mr-[64px] grid h-[346px] w-[536px] grid-cols-3 grid-rows-5 justify-items-center gap-1 rounded-xl pt-[25px] font-ibarra text-lg text-neutral-light backdrop-blur-sm">
            ...
            <img src="./assets/icon/scorecupgold.svg" alt="golden cup" />
            <div>Wizard</div>
            <div>1000 pts</div>
            <img src="./assets/icon/scorecupsilver.svg" alt="silver cup" />
            <div>Harry</div>
            <div>500 pts</div>
            <img src="./assets/icon/scorecupbronze.svg" alt="bronze cup" />
            <div>Ron</div>
            <div>350 pts</div>
            <div />
            <div>Dobby</div>
