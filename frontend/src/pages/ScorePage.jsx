      ...
      <Layout>
        <div>
          <img
            ...
            className=" absolute left-[50%] top-[35%] z-10 h-[120px] w-[169px] rotate-[-8deg]"
          />
          <h1 className="mr-[64px] mt-[84px] flex justify-end font-cinzel text-4xl text-neutral-light">
            Best players
          </h1>
